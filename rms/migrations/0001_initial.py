    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rms.ir')),
            ],
        ),
        migrations.CreateModel(
            name='Iteration',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.IntegerField()),
                ('state', models.TextField(choices=[('TODO', 'Todo'), ('WIP', 'Wip'), ('Reviewing', 'Reviewing'), ('Done', 'Done')])),
                ('createdAt', models.FloatField(default=1648267711.016804)),
                ('disabled', models.BooleanField(default=False)),
                ('IR', models.ManyToManyField(through='rms.IRSRAssociation', to='rms.ir')),
                ('createdBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ums.user')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ums.project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('iteration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rms.iteration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('formerState', models.TextField(choices=[('TODO', 'Todo'), ('WIP', 'Wip'), ('Done', 'Done')])),
                ('formerDescription', models.TextField()),
                ('changedAt', models.FloatField(default=1648267711.018432)),
                ('SR', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rms.sr')),
                ('changedBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ums.user')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ums.project')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='SR',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rms.sr'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='useriterationassociation',
            index=models.Index(fields=['iteration'], name='rms_userite_iterati_9592cc_idx'),
        ),
        migrations.AddIndex(
            model_name='useriterationassociation',
            index=models.Index(fields=['user', 'iteration'], name='rms_userite_user_id_30c74e_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='sr',
            index=models.Index(fields=['title', 'project'], name='rms_sr_title_72d64e_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='sr',
        ...
        migrations.AddIndex(
            model_name='service',
            index=models.Index(fields=['project'], name='rms_service_project_55e4c2_idx'),
        ),
        migrations.AddIndex(
            model_name='service',
        ...
        migrations.AddIndex(
            model_name='service',
            index=models.Index(fields=['title', 'project'], name='rms_service_title_0791c9_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='service',
            unique_together={('project', 'title')},
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['project'], name='rms_iterati_project_4bbbb8_idx'),
        ),
        migrations.AddIndex(
            model_name='ir',
        ...
        migrations.AddIndex(
            model_name='ir',
            index=models.Index(fields=['title', 'project'], name='rms_ir_title_0bba6a_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='ir',
            unique_together={('project', 'title')},
